...
//Calcule la liste des blocs de base : il faut délimiter les BB, en parcourant
// la liste des lignes/instructions à partir de la premiere,
// il faut s'arreter à chaque branchement
// (et prendre en compte le delayed slot qui appartient au meme BB,
// c'est l'instruction qui suit tout branchement) car il indique la fin
// d'un BB/une entete qui est l'instruction qui suit l'instruction
// du delayed slot ou à chaque label (on estime que tout label est utilisé
